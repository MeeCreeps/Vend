...
public:
     ...
     * */
    // edge format
    virtual bool Get(const uint32_t &key, uint32_t *value) = 0;

    // adjacency list format
    virtual bool Get(const uint32_t &key, std::vector<uint32_t> *value) = 0;

    virtual bool Get(const uint32_t &key, std::set<uint32_t> *value) = 0;
    ...
    virtual bool Put(const uint32_t &key, const uint32_t &value) = 0;

    virtual bool Put(const uint32_t &key, const std::vector<uint32_t> &value) = 0;
