...
static constexpr int PLAN_NUMS = 5;
static VendType Vends[5] = {VendType::BloomFilterBit, VendType::BloomFilterInt, VendType::Range,
                            VendType::HashBit, VendType::Hybrid};
